...
function parseObj(objFile, inputPath, done) {
    fs.readFile(objFile, 'utf-8', function (err, contents) {
        ...
        getMaterials(contents, inputPath, function (materials) { // get materials into the materials list.
            var i, length;
            ...
            if (generateNormals) {
                ...
                for (i = 0; i < locations; ++i) {
                    vertexNormals[i * 3 + 0] = 0; // TODO: actually generate the normals?
            ...
            var materialGroups = {};
            var matIndexArray; // ptr to the appropriate index array in materialGroups
            ...
            // use default material if need be. where does this get set otherwise?
            ...
            function createVertex(p, u, n) {
                ...
                positionMin[0] = Math.min(px, positionMin[0]); // for aabb
            ...
            function addFace(v1, p1, u1, n1, v2, p2, u2, n2, v3, p3, u3, n3, v4, p4, u4, n4) {
                var index1 = addVertex(v1, p1, u1, n1); // adds vertex if it hasn't been seen yet
                var index2 = addVertex(v2, p2, u2, n2); // otherwise, returns the index of this vert
                var index3 = addVertex(v3, p3, u3, n3);

                matIndexArray.push(index1); // every vertex in this face must use one material
                matIndexArray.push(index2); // question: does this lead to repeat indices?
                matIndexArray.push(index3); // possibly. nbd?
            ...
            // handle the actual parsing of the obj, adding of faces
            ...
            for (i = 0; i < length; ++i) {
                ...
                if ((line.length === 0) || (line.charAt(0) === '#')) {
                    ...
                    useMaterial(materialName); // line indicates mtl to use for subsequent faces
                }
            }
